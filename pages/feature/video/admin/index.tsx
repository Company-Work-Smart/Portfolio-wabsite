...
function VideoAdminManagement() {
  ...
  const getVideo = async () => {
    const res = await http.get(`AdminVideo`);
    setDatasource(res.item);
  };

  const onConfirm = async (id: string) => {
    await http.delete(`AdminVideo/${id}`);
...
VideoAdminManagement.getLayout = (page) => (
  <SidebarLayout>{page}</SidebarLayout>
);

export default VideoAdminManagement;
