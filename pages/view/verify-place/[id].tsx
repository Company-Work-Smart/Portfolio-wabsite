...
const VerifyPlacePage = () => {
  ...
  const getIdentificationPlace = async () => {
    const res = await http.get(`UserIdentificationPlace`);
    if (Array.isArray(res) && res[0]?.status === 'Pending') {
      await router.push(`/view/verify-card/${id}?refresh=true`);
    }
  };
    ...
    <>
      ...
      >
        <Typography variant="h3" gutterBottom>
          Please provide images of Hotels, Guesthouses, and Resorts.
        </Typography>
        <Typography variant="subtitle1" sx={{ mb: 4 }}>
          Please upload your images of Hotels, Guesthouses, and Resorts here.
        </Typography>
                ...
                {imagePreviews.length > 0 && (
                  <Box>
                    <Typography gutterBottom>
                      Preview of Uploaded Hotels, Guesthouses, and Resorts.
                    </Typography>
