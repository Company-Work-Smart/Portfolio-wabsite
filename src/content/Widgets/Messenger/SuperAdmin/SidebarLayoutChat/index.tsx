...
const SuperAdminSidebarLayoutChat: FC<SuperAdminSidebarLayoutProps> = ({id, children }) => {
...
SuperAdminSidebarLayoutChat.propTypes = {
  children: PropTypes.node,
  id: PropTypes.node
};

export default SuperAdminSidebarLayoutChat;
