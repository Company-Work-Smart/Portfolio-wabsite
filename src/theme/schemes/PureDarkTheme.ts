...
const colors = {
  ...
  shadows: {
    card: `0px 4px 8px ${alpha(Colors.white, 0.1)}`,
  ...
  layout: {
    ...
    sidebar: {
      background: darkTheme.highlight,
      ...
      menuItemIconColor: lighten(Colors.white, 0.3),
      menuItemIconColorActive: darkTheme.accent,
      menuItemHeadingColor: darken(Colors.white, 0.3)
    },
    header: {
