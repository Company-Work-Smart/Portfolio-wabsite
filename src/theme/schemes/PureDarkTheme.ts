...
const colors = {
  gradients: {},
  shadows: {
    card: `0px 4px 8px ${alpha(BaseColors.white, 0.1)}`,
    info: `0px 4px 8px ${alpha(BaseColors.info, 0.1)}`,
    success: `0px 4px 8px ${alpha(BaseColors.success, 0.1)}`,
    pending: `0px 4px 8px ${alpha(BaseColors.pending, 0.1)}`,
    primary: `0px 4px 8px ${alpha(BaseColors.primary, 0.1)}`,
    warning: `0px 4px 8px ${alpha(BaseColors.warning, 0.1)}`,
    error: `0px 4px 8px ${alpha(BaseColors.error, 0.1)}`
  },
  layout: {
    general: {
    ...
    sidebar: {
      background: DarkTheme.sidebar,
      textColor: BaseColors.white,
      dividerBg: '#f2f5f9',
      menuItemColor: '#242E6F',
      menuItemColorActive: DarkTheme.accent,
      menuItemBg: DarkTheme.highlight,
      menuItemBgActive: '#f2f5f9',
      menuItemIconColor: lighten(BaseColors.white, 0.3),
      menuItemIconColorActive: DarkTheme.accent,
      menuItemHeadingColor: darken(BaseColors.white, 0.3)
    },
    header: {
      background: DarkTheme.header,
      boxShadow: DarkTheme.highlight,
      textColor: BaseColors.white
    }
  },
  alpha: {
...
export const PureDarkTheme = createTheme({
  ...
  mode: {
    ...
    action: {
      hover: colors.alpha.white[10],
      select: colors.alpha.white[10]
    },
    border: {
      5: alpha(BaseColors.white, 0.02),
      10: alpha(BaseColors.white, 0.1),
  ...
  components: {
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: alpha(darken(DarkTheme.highlight, 0.4), 0.2),
